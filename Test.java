...
public class Test {
    ...
    private static void cctv() {
        ...
        for (String string : strings) {
            ...
            if (tvName.contains("CCTV-17") || tvName.contains("CCTV17")) {
            ...
            } else if (tvName.contains("CCTV-16") || tvName.contains("CCTV16")) {
            ...
            } else if (tvName.contains("CCTV-15") || tvName.contains("CCTV15")) {
            ...
            }else if (tvName.contains("CCTV-14") || tvName.contains("CCTV14")) {
            ...
            }else if (tvName.contains("CCTV-13") || tvName.contains("CCTV13")) {
            ...
            }else if (tvName.contains("CCTV-12") || tvName.contains("CCTV12")) {
            ...
            }else if (tvName.contains("CCTV-11") || tvName.contains("CCTV11")) {
            ...
            }else if (tvName.contains("CCTV-10") || tvName.contains("CCTV10")) {
            ...
            }else if (tvName.contains("CCTV-5+") || tvName.contains("CCTV5+")) {
            ...
            }else if (tvName.contains("CCTV-9") || tvName.contains("CCTV9")) {
            ...
            }else if (tvName.contains("CCTV-8")  || tvName.contains("CCTV8")) {
            ...
            }else if (tvName.contains("CCTV-7")  || tvName.contains("CCTV7")) {
            ...
            }else if (tvName.contains("CCTV-6")  || tvName.contains("CCTV6")) {
            ...
            }else if (tvName.contains("CCTV-4")  || tvName.contains("CCTV4")) {
            ...
            }else if (tvName.contains("CCTV-3")  || tvName.contains("CCTV3")) {
            ...
            }else if (tvName.contains("CCTV-2")  || tvName.contains("CCTV2")) {
            ...
            }else if (tvName.contains("CCTV-1")  || tvName.contains("CCTV1")) {
