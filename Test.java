...
public class Test {
    ...
    private static void cctv() {
        ...
        for (String string : strings) {
            ...
            } else if (tvName.contains("CCTV16")) {
            ...
            } else if (tvName.contains("CCTV15")) {
            ...
            }else if (tvName.contains("CCTV14")) {
            ...
            }else if (tvName.contains("CCTV13")) {
            ...
            }else if (tvName.contains("CCTV12")) {
            ...
            }else if (tvName.contains("CCTV11")) {
            ...
            }else if (tvName.contains("CCTV10")) {
